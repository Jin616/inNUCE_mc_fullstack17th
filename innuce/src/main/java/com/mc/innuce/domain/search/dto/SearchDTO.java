...
public class SearchDTO {
	...
	public SearchDTO(int keyword_key, int user_key, String client_key) {
		super();
		this.keyword_key = keyword_key;
	...
	public void setSearch_age(String search_age) {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(client_key, other.client_key) && keyword_key == other.keyword_key
				&& Objects.equals(search_age, other.search_age) && Objects.equals(search_gender, other.search_gender)
				&& search_key == other.search_key && Objects.equals(search_time, other.search_time)
