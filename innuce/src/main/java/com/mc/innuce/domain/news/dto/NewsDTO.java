...
public class NewsDTO {
	...
	public String toString() {
		return "NewsDTO [news_key=" + news_key + ", press_key=" + press_key + ", news_title=" + news_title
				+ ", \nnews_content=" + news_content.substring(0, 20) + ", news_writendate=" + news_writendate
				+ ", news_updatedate=" + news_updatedate + ", news_pulldate=" + news_pulldate + ", news_writer="
				+ news_writer + ", \nnews_uri=" + news_uri + ", news_originuri=" + news_originuri + ", \nnews_deleted="
				+ news_deleted + ", news_deleteddate=" + news_deleteddate + ", news_deletedcode=" + news_deletedcode
				+ ", news_category=" + news_category + ", \nnews_thumbnailuri=" + news_thumbnailuri
				+ ", news_thumbnailuri2=" + news_thumbnailuri2 + ", \nsumm_content=" + summ_content
				+ ", \nsumm_sentiment=" + summ_sentiment + ", summ_sentimentpercent=" + summ_sentimentpercent + "]";
	}
