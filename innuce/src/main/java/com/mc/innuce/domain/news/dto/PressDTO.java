...
public class PressDTO {
	...
	public boolean equals(Object obj) {
		...
		if (press_key != other.press_key)
			return false;
		if (!press_name.equals(other.press_name))
			return false;
		if (!press_logo.equals(other.press_logo))
			return false;
		if (!press_mainpage.equals(other.press_mainpage))
			return false;
		if (!press_navermain.equals(other.press_navermain))
			return false;
